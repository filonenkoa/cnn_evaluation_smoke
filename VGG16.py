...
for num_variant in range(len(variants)):
    ...
    results_filename = '{}_{}_{}_B{}_E{}_F{}_NEW.txt'.format(NET_NAME, TRAIN_SET[-11:-7], TEST_SET[-11:-7], BATCH_SIZE, EPOCHS, INPUT_FRAME_SIZE)
    f = open(results_filename, 'wb')
    data = 'Test accuracy = {}\r\nTrain accuracy = {}'.format(test_acc, score[1])
    f.write(data)
    f.close()
    ...
    print('Loading model')
    model = VGG16(weights=None, include_top=True, classes=NUMBER_OF_CLASSES)
